Clicca "Commit changes" (verde)
FILE 2: Layout.js
Apri: https://github.com/wq6bvjj9fj-lab/Fisam-Academy-app-1/blob/main/frontend/src/components/Layout.js
Stessa procedura: matita → Ctrl+A → cancella → incolla questo codice:
